...
from app.api.v1 import auth, companies, company_parameters, customers, dashboard, roles, users, work_orders, work_order_quotes, work_order_repairs
...
router.include_router(work_order_quotes.router, prefix="/work-orders", tags=["work-order-quotes"])\nrouter.include_router(work_order_repairs.router, prefix="/work-orders", tags=["work-order-repairs"])
